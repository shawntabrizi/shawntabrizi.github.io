...
> **Learn More:** Check out my deep-dive into Substrate storage [here](/blog/substrate-storage-deep-dive/).
...
> **Note:** The construction of storage keys for maps has slightly changed from when this was written. You can find an up to date version of that key construction in my post ["Transparent Keys in Substrate"](/blog/transparent-keys-in-substrate/).
...
> **Note:** Now you CAN figure out the `AccountId` for all these balances! Learn how in my post ["Transparent Keys in Substrate"](/blog/transparent-keys-in-substrate/).
